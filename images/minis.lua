...
function new()
	...
	local menuDescr = "Minis screen"
	local menuInstr = "This is the minis screen.  Here there is a list of earned mini games.  You earn the mini games by completing hunts."
