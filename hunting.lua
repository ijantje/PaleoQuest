...
function new()
	...
	local menuDescr = "Hunting screen"
	local menuInstr = "This is the hunting screen. This is where the hunt you selected is played.  Notice the new hunting toolbar.  When you click on the map, it shows where the questions/activities are in the museum.  To select an activity, you touch it on the map.  When it is completed, it turns a different color."
