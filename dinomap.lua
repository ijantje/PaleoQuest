...
function new()
	...
	local menuDescr = "Dino map mini game"
	local menuInstr = "This is a place marker for a mini game.  This should be data driven from the selection on the previous page."
