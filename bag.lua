...
function new()
	...
	local menuDescr = "Hunting bag screen"
	local menuInstr = "This is the hunting bag screen. This is where you can see the puzzle pieces that you have unlocked by completed activities."
